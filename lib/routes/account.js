  ...
  var routes = [
        ...
        function createAccount () {
          ...
          .then(
            function (result) {
              ...
              log.activityEvent('account.created', request, metricsContext.add({
    ...
    },
    {
      ...
      handler: function (request, reply) {
        ...
        function createSessionToken () {
          log.activityEvent('account.login', request, metricsContext.add({
    ...
    },
    {
      ...
      handler: function accountReset(request, reply) {
        ...
        return password.verifyHash()
          ...
          .then(
            function (account) {
              log.activityEvent('account.reset', request, metricsContext.add({
                uid: account.uid.toString('hex')
